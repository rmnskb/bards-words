  ...
  return (
    <div role="status flex flex-col items-center justify-center">
      <svg 
        aria-hidden="true"
        className="
          inline w-8 h-8 animate-spin 
          text-parchment fill-royal-wine
          dark:text-quill dark:fill-crimson
        "
        viewBox="0 0 100 101" 
        fill="none" 
      ...
      >
        <path
          d="
            ...
            50.5908C90.9186 27.9921 72.5987 9.67226 50 9.67226C27.4013 9.67226 9.08144
      ...
      <span className="font-im-fell text-xl ml-3">Loading...</span>
    </div>
  );
};
